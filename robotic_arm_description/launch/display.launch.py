"""
Launch file for robotic_arm.

Usage:
    ros2 launch robotic_arm_description display.launch.py
    ros2 launch robotic_arm_description display.launch.py namespace:=robot1
"""
...
def generate_launch_description():
    pkg_dir = get_package_share_directory('robotic_arm_description')

    xacro_file = os.path.join(pkg_dir, 'urdf', 'robotic_arm.urdf.xacro')
